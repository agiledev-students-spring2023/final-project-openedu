...
import { Subjects } from "./pages/landing/subjects/SubjectList";
import { Begin } from "./pages/landing/begin/Begin";
import { Layout } from "./containers/Layout/Layout";
import { Courses } from "./pages/landing/subjects/SubjectDetail";
    ...
    <div>
      <Layout>
        <Routes>
          ...
          <Route path="/subject_detail/:subjectId" element={<Courses />} />
